...
#--------------------------------------------------------------------
# modified by tomasz jadowski (jadowski at proton dot me) 2016-2018
#--------------------------------------------------------------------
# LICENSE
#
...
feed=$metadir/feed
program="CatchPodder v0.1.0 (https://github.com/oldprogrammer0x01/catchpodder.bash)"
timeout=30
retry=10
...
function usage {
    echo $program
    echo
    echo "Usage: catchpodder.bash init | sync | download | help"
    echo "                                                "
